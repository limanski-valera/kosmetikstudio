(() => {
    ...
    function initSliders() {
        if (document.querySelector(".master__slider")) {
            const sliders = document.querySelectorAll(".master__slider");
...
***************************************************************************** */
    ...
    function initLanguages() {
        if (document.querySelector(".language")) {
            ...
            document.addEventListener("click", (e => {
                if (e.target.closest(".language__button")) wrapper.classList.toggle(activeClass); else if (wrapper.classList.contains(activeClass) && !e.target.closest(".language")) wrapper.classList.remove(activeClass);
            }));
        }
    }
    ...
    async function initForm() {
        ...
        if (form && popupButton) form.addEventListener("submit", formSubmit);
    }
